...
if __name__ == "__main__":
    ...
    resnet50 = asnn('Electron')
    print(' |--- ASNN Version: {} +---| '.format(resnet50.get_nn_version()))
    ...
    '''
    outputs = resnet50.nn_inference(cv_img, platform = 'ONNX', reorder='2 1 0', output_format=output_format.OUT_FORMAT_FLOAT32)
    end = time.time()
